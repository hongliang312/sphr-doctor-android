...
import com.lightheart.sphr.doctor.di.component.DaggerFragmentComponent;
import com.lightheart.sphr.doctor.di.component.FragmentComponent;
...
public abstract class BaseFragment<T extends BaseContract.BasePresenter> extends RxFragment implements BaseContract.BaseView {
    ...
    private void initFragmentComponent() {
        mFragmentComponent = DaggerFragmentComponent.builder()
                .applicationComponent(((DCApplication) getActivity().getApplication()).getApplicationComponent())
