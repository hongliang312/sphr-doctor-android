...
//*******************************************内需方法********************************************//
    ...
    private static Toast custom(@NonNull Context context, @NonNull String message, int duration, boolean withIcon) {
        ...
        setBackground(toastLayout, getDrawable(context, R.drawable.toast_bg));

        if (withIcon) {
            toastIcon.setVisibility(View.VISIBLE);
            setBackground(toastIcon, getDrawable(context, R.drawable.toast_warn));
        } else
    ...
    private static Toast customCenter(@NonNull Context context, @NonNull String message ,int duration, boolean isSuccess) {
        ...
        final ImageView toastIcon = (ImageView) toastLayout.findViewById(R.id.toast_icon);
        final TextView toastTextView = (TextView) toastLayout.findViewById(R.id.toast_text);
        setBackground(toastLayout, getDrawable(context, R.drawable.toast_bg_center));

        if (isSuccess)
            setBackground(toastIcon, getDrawable(context, R.drawable.toast_success));
        else
            setBackground(toastIcon, getDrawable(context, R.drawable.toast_error));
