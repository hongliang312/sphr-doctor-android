...
import com.guwu.common.R;

import java.util.Collections;
import java.util.List;

/**
 * Created by admin  2020/1/7/14:01
 * Describe
 * 作者 洪亮 admin
 */
public class WXTouchHelper extends ItemTouchHelper.Callback {
    ...
    public WXTouchHelper(RecyclerView.Adapter adapter, List<String> imagesList, NestedScrollView scrollView) {
    ...
    public void onChildDraw(Canvas c, RecyclerView recyclerView, RecyclerView.ViewHolder viewHolder, float dX, float dY, int actionState, boolean isCurrentlyActive) {
        ...
        int editTextHeight=ToastUtil.getContext().getResources().getDimensionPixelSize( R.dimen.dp_100);//recyclerview上面的editText的高度为100
        int buttonHeight=ToastUtil.getContext().getResources().getDimensionPixelSize(R.dimen.dp_50);//删除按钮高度
        /**
         ...
         */
        int spaceHeight=ToastUtil.getContext().getResources().getDimensionPixelSize(R.dimen.dp_10);//
        /**
